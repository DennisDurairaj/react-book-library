...
router.get("/search", (req, res) => {
  request
    .get(`https://www.goodreads.com/search/index.xml?key=3LsrvY9UsDbIYNKFbcjA&q=${req.query.q}`)
    .then(result => parseString(result, (err, goodreadsResult) => res.json({
      books: goodreadsResult
        .GoodreadsResponse
        .search[0]
        .results[0]
        .work
...
router.get("/fetchPages", (req, res) => {
  ...
  request
    .get(`https://www.goodreads.com/book/show/${id}.xml?key=3LsrvY9UsDbIYNKFbcjA`)
    .then(result => {
